...
The plugin includes a number of customization options to allow you to hook it up with Lightbox or any other number of popup overlay display libraries. Third party commenting services such as Disqus are also supported, allowing your visitors to comment on your photos without hopping over to Flickr.com.

A simple Flickr widget is also included to let you easily include your photos into your blog's sidebar.
