...
class silas_xml  {
   ...
   var $_replace = array();//array('°','&',"\n",".");
   var $_replaceWith = array();//array('{deg}', '{amp}', '{lf}','{ESC}');
   var $_struct = array();
   var $_index = array();

   function silas_xml($caseInsensitive = false, $attributesDirectlyUnderParent = false, $childTagsDirectlyUnderParent = false)
   {
   ...
   function parse($xml)
   {
       ...
       $ret = xml_parse_into_struct($this->_parser, $xml, $this->_struct, $this->_index);
